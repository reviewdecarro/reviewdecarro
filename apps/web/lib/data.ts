...
export const threads: Thread[] = [
  {
    ...
    body:
      "# Primeiro carro\n\nEstou comparando sedãs e hatches compactos para uso diário.\n\n- Consumo\n- Manutenção\n- Seguro\n",
  },
  {
    id: 2,
    title:
    ...
    category: "Discussão",
    body:
      "## Confiabilidade no uso real\n\nQuero relatos de quem ficou mais de 5 anos com o carro.\n\n* Revisões\n* Custo de peças\n* Desvalorização\n",
  },
  {
    id: 3,
    title:
    ...
    category: "Discussão",
    body:
      "### Energia no dia a dia\n\nPensando em custo total, o híbrido ainda parece o ponto de equilíbrio.\n",
  },
  {
    id: 4,
    ...
    category: "Dicas de compra",
    body:
      "#### Negociação\n\nMinha abordagem é simples: comparar propostas e sair do primeiro impulso.\n",
  },
  {
    id: 5,
    ...
    category: "Discussão",
    body:
      "## Premium x custo-benefício\n\nO Civic entrega racionalidade. A Série 3 entrega condução e acabamento.\n",
  },
];
...
export const comments: ForumComment[] = [
  ...
  },
  {
    ...
    contextType: "review",
    contextTitle:
      "Toyota Corolla Cross Hybrid: A sensatez nunca pareceu tão boa",
  },
  {
    id: 5,
    author: "frederico",
