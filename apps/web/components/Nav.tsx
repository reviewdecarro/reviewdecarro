        ...
        >
          ...
          >
            <svg width="18" height="14" viewBox="0 0 18 14" fill="none">
              <path d="M2.5 10L5 3H13L15.5 10H2.5Z" fill="white" opacity="0.95"/>
              <circle cx="5" cy="12" r="2" fill="white"/>
              <circle cx="13" cy="12" r="2" fill="white"/>
              <rect x="1" y="9" width="16" height="1.5" rx="0.75" fill="white" opacity="0.5"/>
            </svg>
          </div>
          <span className="font-display font-extrabold text-[19px] tracking-tight" style={{ color: 'var(--text)' }}>
            PapoAuto
          </span>
        </Link>
