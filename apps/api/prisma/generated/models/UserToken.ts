...
export type UserTokenModel =
  runtime.Types.Result.DefaultSelection<Prisma.$UserTokenPayload>;
...
> = {
  where?: Prisma.UserTokenWhereInput;
  orderBy?:
    | Prisma.UserTokenOrderByWithAggregationInput
    | Prisma.UserTokenOrderByWithAggregationInput[];
...
export type GetUserTokenGroupByPayload<T extends UserTokenGroupByArgs> =
...
export type UserTokenWhereInput = {
  ...
  expiresDate?: Prisma.DateTimeFilter<"UserToken"> | Date | string;
...
export type UserTokenScalarWhereWithAggregatesInput = {
  ...
  expiresDate?:
    | Prisma.DateTimeWithAggregatesFilter<"UserToken">
    | Date
    | string;
...
export type UserTokenCreateNestedManyWithoutUserInput = {
  ...
  connect?:
    | Prisma.UserTokenWhereUniqueInput
    | Prisma.UserTokenWhereUniqueInput[];
};
...
export type UserTokenUpdateManyWithoutUserNestedInput = {
  ...
  updateMany?:
    ...
    | Prisma.UserTokenUpdateManyWithWhereWithoutUserInput[];
  deleteMany?:
    | Prisma.UserTokenScalarWhereInput
    | Prisma.UserTokenScalarWhereInput[];
};
...
export type UserTokenCreateManyUserInputEnvelope = {
  data:
    | Prisma.UserTokenCreateManyUserInput
    | Prisma.UserTokenCreateManyUserInput[];
...
> = runtime.Types.Extensions.GetOmit<
  "id" | "refreshToken" | "expiresDate" | "userId" | "createdAt" | "updatedAt",
  ExtArgs["result"]["userToken"]
>;
...
export type UserTokenGetPayload<
  S extends boolean | null | undefined | UserTokenDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, UserTokenGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetUserTokenGroupByPayload<T>
...
export interface UserTokenFieldRefs {
  ...
  readonly expiresDate: Prisma.FieldRef<"UserToken", "DateTime">;
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.UserTokenUpdateInput,
    Prisma.UserTokenUncheckedUpdateInput
  >;
  /**
